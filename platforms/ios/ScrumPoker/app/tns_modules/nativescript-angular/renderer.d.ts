import { NgZone, Renderer, RootRenderer, RenderComponentType, AnimationPlayer } from "@angular/core";
...
export declare class NativeScriptRootRenderer implements RootRenderer {
    ...
    protected readonly animationDriver: NativeScriptAnimationDriver;
...
export declare class NativeScriptRenderer extends Renderer {
    ...
    constructor(rootRenderer: NativeScriptRootRenderer, componentProto: RenderComponentType, animationDriver: NativeScriptAnimationDriver, zone: NgZone);
